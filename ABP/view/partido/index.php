    ...
    <body>
        ...
        <?php if ($anterior != $pista->getHorarioIdPista()) { ?>
                        ...
                        <?php if ($pista->getDisponibilidad() == 'disponible') { ?>
                            <td><a style="border:solid;background-color:green;color:black;" href="index.php?controller=gestionarReservas&amp;action=comprobarReservaPartido&amp;fecha=<?= $pista->getFecha(); ?>&amp;pista=<?= $pista->getHorarioIdPista(); ?>&amp;hora=<?= $pista->getHora(); ?>&amp;disponibilidad=<?= $pista->getDisponibilidad(); ?>"><?php echo $pista->getHora(); ?></a></td>
                            <?php } else { ?>
                            <td><a style="border:solid;background-color:red;color:black;" href="index.php?controller=gestionarReservas&amp;action=comprobarReservaPartido&amp;fecha=<?= $pista->getFecha(); ?>&amp;pista=<?= $pista->getHorarioIdPista(); ?>&amp;hora=<?= $pista->getHora(); ?>&amp;disponibilidad=<?= $pista->getDisponibilidad(); ?>"><?php echo $pista->getHora(); ?></a></td>
        <?php } ?>
    <?php }
} ?>
                </form>
